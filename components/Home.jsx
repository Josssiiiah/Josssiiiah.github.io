      ...
      <div className=" mt-24 lg:mt-6 pb-64 px-8 lg:px-10 max-w-[1500px] w-full h-full mx-auto lg:flex justify-center items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="hidden md:block text-center lg:text-left my-8 lg:max-w-2xl text-black">
            <h4 className="animate__animated animate__fadeInBottomLeft leading-loose">
              ...
              <span className="font-bold"> view the world </span> differently,
              and <span className="font-bold">change it </span> for the better.
            </h4>
          </div>
          <div className="md:hidden py-6 max-w-xl">
            <h4 className="animate__animated animate__fadeInBottomLeft">
              I'm a sophomore studying computer science at
        ...
        {/* Avatar  */}
        <div className="animate__animated animate__fadeIn animate__delay-1s block md:flex justify-center mt-6 lg:ml-12">
          <div>
            <Image
              src={avatar}
              alt="/"
