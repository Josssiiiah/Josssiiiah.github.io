...
import { Tilt as Hamburger } from 'hamburger-react/dist-types/Tilt';
import { Cross } from 'hamburger-react/dist-types/Cross';
import { Divide } from 'hamburger-react/dist-types/Divide';
import { Fade } from 'hamburger-react/dist-types/Fade';
import { Pivot } from 'hamburger-react/dist-types/Pivot';
import { Rotate } from 'hamburger-react/dist-types/Rotate';
import { Slant } from 'hamburger-react/dist-types/Slant';
import { Sling } from 'hamburger-react/dist-types/Sling';
import { Spin } from 'hamburger-react/dist-types/Spin';
import { Spiral } from 'hamburger-react/dist-types/Spiral';
import { Squash } from 'hamburger-react/dist-types/Squash';
import { Squeeze } from 'hamburger-react/dist-types/Squeeze';
import { Turn } from 'hamburger-react/dist-types/Turn';
import { Twirl } from 'hamburger-react/dist-types/Twirl';
